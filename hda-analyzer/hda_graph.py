...
class CodecGraph(gtk.Window):
    def __init__(self, codec):
        ...
        table.attach(
            self.layout, 0, 1, 0, 1, gtk.FILL | gtk.EXPAND, gtk.FILL | gtk.EXPAND, 0, 0
        )
        vScrollbar = gtk.VScrollbar(None)
        table.attach(
            vScrollbar, 1, 2, 0, 1, gtk.FILL | gtk.SHRINK, gtk.FILL | gtk.SHRINK, 0, 0
        )
        hScrollbar = gtk.HScrollbar(None)
        table.attach(
            hScrollbar, 0, 1, 1, 2, gtk.FILL | gtk.SHRINK, gtk.FILL | gtk.SHRINK, 0, 0
        )
        ...
        table.attach(
            statusbar, 0, 2, 2, 3, gtk.FILL | gtk.SHRINK, gtk.FILL | gtk.SHRINK, 0, 0
        )
        self.show_all()
